...
class PostEntity {
    ...
    init(id: Int, text: String, user: UserEntity, image: String? = nil) {
        self.id = id
        self.text = text
        self.user = user
        self.image = image
...
class DummtPostManager {
    ...
    init() {
        ...
        let post2 = PostEntity(id: 2, text: "All he wanted was a candy bar. It didn't seem like a difficult request to comprehend, but the clerk remained frozen and didn't seem to want to honor the request. It might have had something to do with the gun pointed at his face.", user: DummyUserManager.user2, image: "https://images.unsplash.com/photo-1616410011236-7a42121dd981?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aXBob25lfGVufDB8fDB8fHww")
